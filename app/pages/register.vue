    ...
    <div class="max-w-md w-full">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400">
          Ou
          <NuxtLink to="/login" class="font-medium text-primary-600 dark:text-primary-400 hover:underline underline-offset-2">
            connectez-vous
          </NuxtLink>
        </p>
      </div>
      ...
      <div class="grid grid-cols-2 gap-3">
        ...
        <a href="/auth/google" class="block w-full">
          <button
            type="button"
            class="w-full flex items-center justify-center gap-2 py-2.5 px-4 border border-gray-300 dark:border-gray-700 rounded-xl bg-white dark:bg-gray-800 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200 shadow-sm"
          >
