    ...
    <div class="max-w-md w-full">
      ...
      <div class="text-center mb-8">
        <img 
          ...
          alt="EduAI" 
          class="mx-auto h-14 w-auto mb-5"
        />
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400">
          Ou
          <NuxtLink to="/login" class="font-medium text-primary-600 dark:text-primary-400 hover:underline underline-offset-2 cursor-pointer">
            connectez-vous
          </NuxtLink>
        </p>
      </div>
      ...
      <div v-if="error" class="mb-4 p-4 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800">
        <p class="text-sm text-red-800 dark:text-red-400 flex items-center gap-2">
      ...
      <!-- Message de succès -->
      <div v-if="success" class="mb-4 p-4 rounded-xl bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800">
        <p class="text-sm text-green-800 dark:text-green-400 flex items-center gap-2">
        ...
        <div class="space-y-3">
          <div>
            ...
            <input
              ...
              type="text"
              autocomplete="name"
              class="appearance-none block w-full px-4 py-2.5 border border-gray-300 dark:border-gray-700 rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 sm:text-sm cursor-text"
      ...
      <div class="relative my-6">
        ...
        <div class="relative flex justify-center text-sm">
          <span class="px-4 bg-gray-50 dark:bg-gray-900 text-xs font-medium text-gray-400 dark:text-gray-500 uppercase tracking-wider">
            ou s'inscrire avec
          </span>
        </div>
      </div>

      <!-- Boutons OAuth sur la même ligne -->
      <div class="grid grid-cols-2 gap-3">
        <!-- Google -->
        <a href="/auth/google" class="block w-full">
          <button
            type="button"
            class="w-full flex items-center justify-center gap-2 py-2.5 px-4 border border-gray-300 dark:border-gray-700 rounded-xl bg-white dark:bg-gray-800 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200 shadow-sm cursor-pointer"
          >
