...
const message = computed(() => {
  return ({
    'input-available': 'Chargement des données météo...',
    'output-error': 'Impossible d\'obtenir les données météo, veuillez réessayer plus tard'
  })[props.invocation.state as string] || 'Chargement des données météo...'
})
</script>
      ...
      <div class="flex items-start justify-between mb-3">
        ...
        <div class="text-right">
          ...
          <div class="text-xs text-white/70">
            Max:{{ invocation.output.temperatureHigh }}° Min:{{ invocation.output.temperatureLow }}°
          </div>
        </div>
      </div>
