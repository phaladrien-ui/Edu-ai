...
const message = computed(() => {
  return ({
    'input-available': 'Génération du graphique...',
    'output-error': 'Impossible de générer le graphique, veuillez réessayer'
  })[props.invocation.state as string] || 'Chargement des données...'
})
